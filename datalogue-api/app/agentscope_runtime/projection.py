...
# Description:
#   AgentScope Runtime 事件投影门面，re-export project_agentscope_service_event。
#
# Responsibilities:
#   - 暴露 AgentScope Service 事件到 Datalogue 事件的投影入口
#   - 兼容迁移中，不承载新业务逻辑
#
# Author      : KenYang
...
def __getattr__(name: str):
    """兼容迁移中按需加载旧投影函数，避免包导入阶段触发旧运行时循环依赖。"""
