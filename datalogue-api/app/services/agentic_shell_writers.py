# ============================================================
# File Name   : agentic_shell_writers.py
# Description:
#   Agentic Shell 写回适配器。
#
# Responsibilities:
...
from app.services.agentic_shell import AgenticShellWriteRecord
...
class AgentScopeMirrorShellWriter:
    """把 Agentic Shell 写回记录投影到 AgentScope mirror；不直接执行 BI 查询。"""
    ...
    def _write_action(self, record: AgenticShellWriteRecord) -> None:
        ...
        # PR1.4：Workbench retry action 进入 Shell 后仍落为既有 observability contract 事件名。
