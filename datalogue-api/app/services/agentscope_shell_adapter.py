...
class AgentScopeShellAdapter:
    ...
    def __init__(
        ...
        *,
        ...
        ask_bi_func: Callable[[AskBIRequest], AskBIResponse | dict[str, Any] | Any] | None = None,
        ...
        self.ask_bi_tool = BIWorkbenchTool(handler=ask_bi_func) if ask_bi_func else BIWorkbenchTool()
    ...
    async def run(
        ...
        *,
        ...
        ask_bi_response = self.ask_bi_tool.ask_bi(request)
        if inspect.isawaitable(ask_bi_response):
            ask_bi_response = await ask_bi_response
        ...
        return AgentScopeShellResponse(
            ...
            primary_ref=ask_bi_response.primary_ref.ref if ask_bi_response.primary_ref else None,
            related_refs=[item.ref for item in ask_bi_response.related_refs if item.ref],
