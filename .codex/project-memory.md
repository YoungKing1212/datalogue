...
- 修正数据集页面已选表计数、LeadAgent 两阶段 Planner Prompt 去重并同步 Langfuse、新建对话固定进入最近对话顶部；相关验证覆盖前端组件测试、后端 conversation/observability/lead_agent_tools 测试、lint/build 和浏览器检查。
